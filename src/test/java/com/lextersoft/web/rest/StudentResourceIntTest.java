...
import com.lextersoft.domain.Student;
import com.lextersoft.domain.Technologist;
import com.lextersoft.repository.StudentRepository;
import com.lextersoft.service.StudentService;
import com.lextersoft.service.dto.StudentDTO;
import com.lextersoft.service.mapper.StudentMapper;
...
public class StudentResourceIntTest {
    ...
    public static Student createEntity(EntityManager em) {
        Student student = new Student()
            ...
            .email(DEFAULT_EMAIL);
        // Add required entity
        Technologist technologist = TechnologistResourceIntTest.createEntity(em);
        em.persist(technologist);
        em.flush();
        student.setTechnologist(technologist);
        return student;
    }
    ...
    public void createStudent() throws Exception {
        ...
        assertThat(testStudent.getEnrollment()).isEqualTo(DEFAULT_ENROLLMENT);
    ...
    @Test
    @Transactional
    public void checkEnrollmentIsRequired() throws Exception {
        int databaseSizeBeforeTest = studentRepository.findAll().size();
        // set the field null
    ...
    public void getAllStudents() throws Exception {
        ...
        restStudentMockMvc.perform(get("/api/students?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].enrollment").value(hasItem(DEFAULT_ENROLLMENT.toString())))
    ...
    public void getStudent() throws Exception {
        ...
        restStudentMockMvc.perform(get("/api/students/{id}", student.getId()))
            ...
            .andExpect(jsonPath("$.enrollment").value(DEFAULT_ENROLLMENT.toString()))
    ...
    public void updateStudent() throws Exception {
        ...
        assertThat(testStudent.getEnrollment()).isEqualTo(UPDATED_ENROLLMENT);
