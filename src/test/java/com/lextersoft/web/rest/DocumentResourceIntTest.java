...
public class DocumentResourceIntTest {
    ...
    private static final String DEFAULT_ARCHIVE_NAME = "AAAAAAAAAA";
    private static final String UPDATED_ARCHIVE_NAME = "BBBBBBBBBB";
    ...
    public void createDocument() throws Exception {
        ...
        assertThat(testDocument.getArchiveName()).isEqualTo(DEFAULT_ARCHIVE_NAME);
        assertThat(testDocument.getDecription()).isEqualTo(DEFAULT_DECRIPTION);
    }
    ...
    @Test
    @Transactional
    public void checkArchiveNameIsRequired() throws Exception {
        int databaseSizeBeforeTest = documentRepository.findAll().size();
        // set the field null
        document.setArchiveName(null);
    ...
    public void getAllDocuments() throws Exception {
        ...
        restDocumentMockMvc.perform(get("/api/documents?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].archiveName").value(hasItem(DEFAULT_ARCHIVE_NAME.toString())))
    ...
    public void getDocument() throws Exception {
        ...
        restDocumentMockMvc.perform(get("/api/documents/{id}", document.getId()))
            ...
            .andExpect(jsonPath("$.archiveName").value(DEFAULT_ARCHIVE_NAME.toString()))
    ...
    public void updateDocument() throws Exception {
        ...
        updatedDocument
            ...
            .archiveName(UPDATED_ARCHIVE_NAME)
        ...
        assertThat(testDocument.getArchiveName()).isEqualTo(UPDATED_ARCHIVE_NAME);
        assertThat(testDocument.getDecription()).isEqualTo(UPDATED_DECRIPTION);
    }
